...
urlpatterns = [
    ...
    path('app_cards/competitions/create', CompOrgView.as_view(), name='competitions_org_create'),
    path('app_cards/competitions/create', CompUserView.as_view(), name='competitions_user_create'),
    path('app_cards/seminars/create', SeminarOrgView.as_view(), name='seminars_org_create'),
    path('app_cards/seminars/create', SeminarUserView.as_view(), name='seminars_user_create'),
    ...
    path('app_cards/competitions/update/<int:pk>', CompOrgUpdateView.as_view(), name='competitions_org_update'),
    path('app_cards/competitions/update/<int:pk>', CompUserUpdateView.as_view(), name='competitions_user_update'),
    path('app_cards/seminars/update/<int:pk>', SeminarOrgUpdateView.as_view(), name='seminars_org_update'),
    path('app_cards/seminars/update/<int:pk>', SeminarUserUpdateView.as_view(), name='seminars_user_update'),
    ...
    path('event/complete/<int:pk>', event_change_active, name='event_change_active'),
